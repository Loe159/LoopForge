...
| Path | Current role |
| --- | --- |
| `src/loopforge/cli/` | CLI facade, parser, command handlers, interactive shell, and rendering |
...
| `src/loopforge/contracts/`, `templates/`, `packs/` | Policies/schemas, legacy templates, and bundled packs |
